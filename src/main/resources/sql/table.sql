...
CREATE TABLE `w_servert_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `servert_id` bigint(20) NOT NULL,
  `servert_name` varchar(20) NOT NULL,
  `servert_remark` varchar(1000) DEFAULT NULL,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` varchar(45) NOT NULL,
  `last_modified_by` varchar(45) DEFAULT NULL,
  `last_modified_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='英灵信息表';
...
CREATE TABLE `w_servert_level_info` (
  ...
  `last_modified_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='英灵等级信息表';
...
CREATE TABLE `w_servert_role` (
  ...
  `type_` int(11) NOT NULL COMMENT '英灵职阶',
  `level_` int(11) NOT NULL DEFAULT '1' COMMENT '英灵等级',
  `skill_1_level` int(11) NOT NULL DEFAULT '1',
  `skill_2_level` int(11) NOT NULL DEFAULT '1',
  `skill_3_level` int(11) NOT NULL DEFAULT '1',
  `tool_level` int(11) NOT NULL DEFAULT '1' COMMENT '宝具等级',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` varchar(45) NOT NULL,
  `last_modified_by` varchar(45) DEFAULT NULL,
  `last_modified_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='英灵列表';
